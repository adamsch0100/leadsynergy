"""Script to check Redfin for any urgent/overdue leads"""
import os
import sys
...
print("\n[STEP 1] Attempting Redfin login...")
print("NOTE: Redfin uses Google OAuth - you may need to manually interact with the browser")
...
try:
    if service.login():
        ...
        urgent_keywords = ['urgent', 'overdue', 'action required', 'needs attention', 'past due']
        found_urgent = []
        ...
        print("Redfin may require manual Google OAuth authentication")
