...
export const FUTURE_ADDONS: FutureAddOn[] = [
  ...
  },
  {
    ...
    description: "Intelligent email follow-ups through FUB email integration",
    priceEstimate: "Included",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "Score-based routing",
      "Automatic handoff when qualified",
    ],
    status: "available",
  },
  {
