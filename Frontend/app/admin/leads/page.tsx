...
export default function AdminLeadsPage() {
  ...
  if (assignmentFilter === "assigned") {
    filteredLeads = filteredLeads.filter(l => l.assigned_user_id)
    ...
    <SidebarWrapper role="admin">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            View all leads across your organization ({filteredLeads.length} of {leads.length} leads)
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage all leads from Follow Up Boss</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <TableRow key={lead.id}>
                    ...
                    <TableCell>
                      {lead.assigned_user_name ? (
                        <Badge variant="secondary">{lead.assigned_user_name}</Badge>
                      ) : (
