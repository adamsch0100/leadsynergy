...
import { Clock, MessageSquare, Phone, RefreshCw, AlertTriangle } from "lucide-react"
...
export default function LeadsPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      // Fetch leads and FUB stages in parallel (fetch up to 2000 leads)
    ...
    <SidebarWrapper role="agent">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Manage and track your assigned leads ({leads.length} total)</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View and manage your assigned leads from Follow Up Boss</CardDescription>
        </CardHeader>
        <CardContent>
          {filteredLeads.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              No leads found. Import leads from the Lead Sources page or check your filters.
            </div>
          ) : (
            <Table>
              <TableHeader>
